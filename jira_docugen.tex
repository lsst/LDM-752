...
% using docsteady version 1.2rc21.post0+g596756a.d20200810
...
Requirement Description & \textbf{Specification:} Identified transient events shall be made
...
community standards evolve. \\ \cdashline{1-2}
...
\end{itemize}
 ...
 \newpage \subsection{[LVV-6] DMS-REQ-0009-V-01: Simulated Data }\label{lvv-6}

\begin{longtable}{ccccc}
\hline
\textbf{Jira Link} & \textbf{Assignee} & \textbf{Status} & \textbf{Priority} & \textbf{Test Cases}\\ \hline
\href{https://jira.lsstcorp.org/browse/LVV-6}{LVV-6} &
Jim Bosch & Not Covered & 1b &
\begin{tabular}{c}
LVV-T125 \\
\end{tabular}
\\
...
testing.
 ...
 \newpage \subsection{[LVV-7] DMS-REQ-0010-V-01: Difference Exposures }\label{lvv-7}
...
Requirement Description & \textbf{Specification:} The DMS shall create a Difference Exposure from
each Processed Visit Image by subtracting a re-projected, scaled,
PSF-matched Template Image in the same passband. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} Difference Exposures are not archived, and are
retained for only a limited time to facilitate Alert processing. They
can be re-generated for users on-demand. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
2. Difference Exposure from each Processed Visit Image
 ...
 \newpage \subsection{[LVV-8] DMS-REQ-0018-V-01: Raw Science Image Data Acquisition }\label{lvv-8}
...
Requirement Description & \textbf{Specification:} The DMS shall acquire raw Exposure data from the
Camera science sensors during normal operations, calibration data
collection, and in any other required engineering modes. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} The manner of data acquisition is a matter for the
DM-Camera ICDs, \citeds{LSE-69} and \citeds{LSE-68}, in this area. \\ \cdashline{1-2}
...
through an instance of the LSP
 ...
 \newpage \subsection{[LVV-9] DMS-REQ-0020-V-01: Wavefront Sensor Data Acquisition }\label{lvv-9}
...
other required operating modes. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} The details of this are a matter for the DM-Camera
...
archiving of any raw guider sensor data. \\ \cdashline{1-2}
Requirement Priority & 1a \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
through an instance of the LSP
 ...
 \newpage \subsection{[LVV-11] DMS-REQ-0024-V-01: Raw Image Assembly }\label{lvv-11}
...
Requirement Description & \textbf{Specification:} The DMS shall assemble the combination of raw
...
community. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} Relevant exposure metadata are those that define
the observing context, telescope and instrument configuration, and
provenance. \\ \cdashline{1-2}
Requirement Priority & 1a \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0114 & Acquisition of Science Sensor data \\
...
through an instance of the LSP
 ...
 \newpage \subsection{[LVV-12] DMS-REQ-0029-V-01: Generate Photometric Zeropoint for Visit Image }\label{lvv-12}
...
Requirement Description & \textbf{Specification:} The DMS shall derive and persist a photometric
zeropoint for each visit image, per CCD. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
flux on the image to physical flux units.
 ...
 \newpage \subsection{[LVV-13] DMS-REQ-0030-V-01: Absolute accuracy of WCS }\label{lvv-13}

\begin{longtable}{ccccc}
\hline
\textbf{Jira Link} & \textbf{Assignee} & \textbf{Status} & \textbf{Priority} & \textbf{Test Cases}\\ \hline
\href{https://jira.lsstcorp.org/browse/LVV-13}{LVV-13} &
Jim Bosch & Not Covered & 1a &
\begin{tabular}{c}
LVV-T15 \\
LVV-T19 \\
LVV-T40 \\
...
Requirement Description & \textbf{Specification:} The DMS shall generate and persist a WCS for
...
standards available in each CCD. \\ \cdashline{1-2}
...
Requirement Discussion & \textbf{Discussion:} The World Coordinate System for visits will be
...
of coordinate transformations. \\ \cdashline{1-2}
Requirement Priority & 1a \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
DMS-REQ-0090 & Generate Alerts \\
...
the bounds of the image.
 ...
 \newpage \subsection{[LVV-14] DMS-REQ-0032-V-01: Image Differencing }\label{lvv-14}
...
Requirement Description & \textbf{Specification:} The DMS shall provide software to perform image
differencing, generating Difference Exposures from the comparison of
single exposures and/or coadded images. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
exposures and coadds.
 ...
 \newpage \subsection{[LVV-15] DMS-REQ-0033-V-01: Provide Source Detection Software }\label{lvv-15}
...
Requirement Description & \textbf{Specification:} The DMS shall provide software for the detection
of sources in a calibrated image, which may be a Difference Image or a
Co-Add image. \\ \cdashline{1-2}
Requirement Priority & 1a \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
single ``meta-package'', lsst\_distrib.
 ...
 \newpage \subsection{[LVV-16] DMS-REQ-0034-V-01: Associate Sources to Objects }\label{lvv-16}
...
Requirement Description & \textbf{Specification:} The DMS shall associate Sources measured at
different times and in different passbands with entries in the Object
catalog. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} The task of association is to relate Sources from
...
best guess at the Object it corresponds to.
 ...
 \newpage \subsection{[LVV-17] DMS-REQ-0042-V-01: Provide Astrometric Model }\label{lvv-17}
...
Requirement Description & \textbf{Specification:} An astrometric model shall be provided for every
Object and DIAObject which specifies at least the proper motion and
parallax, and the estimated uncertainties on these quantities. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
DIAObjects.
 ...
 \newpage \subsection{[LVV-18] DMS-REQ-0043-V-01: Provide Calibrated Photometry }\label{lvv-18}
...
Requirement Description & \textbf{Specification:} The DMS shall provide calibrated photometry in
...
source, above the atmosphere. Fluxes, possibly in jansky, shall be
calculated for all measured entities. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} Note that the SED is only assumed to be flat within
the passband of the measurement. \\ \cdashline{1-2}
Requirement Priority & 1a \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0130 & Catalogs (Level 1) \\
...
DRP and AP products.
 ...
 \newpage \subsection{[LVV-19] DMS-REQ-0046-V-01: Provide Photometric Redshifts of Galaxies }\label{lvv-19}

\begin{longtable}{ccccc}
\hline
\textbf{Jira Link} & \textbf{Assignee} & \textbf{Status} & \textbf{Priority} & \textbf{Test Cases}\\ \hline
\href{https://jira.lsstcorp.org/browse/LVV-19}{LVV-19} &
Jim Bosch & Not Covered & 2 &
\begin{tabular}{c}
LVV-T68 \\
\end{tabular}
\\
...
Requirement Description & \textbf{Specification:} The DMS shall compute a photometric redshift for
all detected Objects. \\ \cdashline{1-2}
...
photometric redshift information.
 ...
 \newpage \subsection{[LVV-20] DMS-REQ-0047-V-01: Provide PSF for Coadded Images }\label{lvv-20}
...
Requirement Description & \textbf{Specification:} The DMS shall determine a characterization of
the PSF for any specified location in coadded images. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} The PSF model will be primarily used to perform
initial object characterization and bootstrapping of multi-epoch object
characterization (e.g., Multifit). \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0153 & World Coordinate System Accuracy \\
...
obtained.
 ...
 \newpage \subsection{[LVV-21] DMS-REQ-0052-V-01: Enable a Range of Shape Measurement Approaches }\label{lvv-21}
...
Requirement Description & \textbf{Specification:} The DMS shall provide for the use of a variety
...
the information from the individual Exposures simultaneously. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} The most appropriate measurement model to apply
depends upon the nature of the composite source. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0137 & Catalogs (Level 2) \\
...
Verify that multiple shape measurement algorithms can be used.
 ...
 \newpage \subsection{[LVV-22] DMS-REQ-0059-V-01: Bad Pixel Map }\label{lvv-22}
...
Requirement Description & \textbf{Specification:} The DMS shall produce on an as-needed basis a
...
down-stream processing software. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} The fraction of bad pixels is expected to be small.
Therefore the Reference Map, while logically equivalent to an image, may
be stored in a more compressible form. \\ \cdashline{1-2}
Requirement Priority & 1a \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
32-bit values.
 ...
 \newpage \subsection{[LVV-23] DMS-REQ-0060-V-01: Bias Residual Image }\label{lvv-23}
...
Requirement Description & \textbf{Specification:} The DMS shall construct on an as-needed basis an
...
correction has been applied. \\ \cdashline{1-2}
Requirement Priority & 1a \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
\end{itemize}
 ...
 \newpage \subsection{[LVV-24] DMS-REQ-0061-V-01: Crosstalk Correction Matrix }\label{lvv-24}
...
Requirement Description & \textbf{Specification:} The DMS shall, on an as-needed basis, determine
...
production processing on science data. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} The frequency with which the Cross-talk Correction
Matrix must be computed will be determined during Commissioning and
monitored during operations. \\ \cdashline{1-2}
Requirement Priority & 1a \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
correction matrix.
 ...
 \newpage \subsection{[LVV-25] DMS-REQ-0062-V-01: Illumination Correction Frame }\label{lvv-25}
...
Requirement Description & \textbf{Specification:} The DMS shall produce on an as-needed basis an
...
science data. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} The Illumination correction is anticipated to be
quite stable. Updates to the correction should be no more frequent than
monthly. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0271 & Supported Image Types \\
...
correction and determine how often it should be updated.
 ...
 \newpage \subsection{[LVV-26] DMS-REQ-0063-V-01: Monochromatic Flatfield Data Cube }\label{lvv-26}
...
verified in production processing on science data. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} Monochromatic flat-fields are expected to be
produced no more frequently than monthly, owing to the time required to
obtain the exposures. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0271 & Supported Image Types \\
...
flatfield data cube.
 ...
 \newpage \subsection{[LVV-27] DMS-REQ-0065-V-01: Provide Image Access Services }\label{lvv-27}

\begin{longtable}{ccccc}
\hline
\textbf{Jira Link} & \textbf{Assignee} & \textbf{Status} & \textbf{Priority} & \textbf{Test Cases}\\ \hline
\href{https://jira.lsstcorp.org/browse/LVV-27}{LVV-27} &
Gregory Dubois-Felsmann & Not Covered & 1b &
\begin{tabular}{c}
LVV-T134 \\
\end{tabular}
\\
...
Requirement Description & \textbf{Specification:} The DMS shall provide a service for Image Access
...
format. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} At least the FITS image format will be supported
though an IVOA-standard service such as SIAP. Other image formats such
as JPG may be more compatible with education/public outreach needs. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
\begin{itemize}
\item . LVV-10004 (\ref{lvv-10004}) DMS-API-REQ-0028-V-01: Access to Image Data in FITS Format_1
\item . LVV-10016 (\ref{lvv-10016}) DMS-API-REQ-0016-V-01: SIA Service for Image Availability_1
\item . LVV-10017 (\ref{lvv-10017}) DMS-API-REQ-0018-V-01: Cutout Service_1
\item . LVV-10018 (\ref{lvv-10018}) DMS-API-REQ-0017-V-01: SODA Service for Image Data_1
\end{itemize}
...
users.
 ...
 \newpage \subsection{[LVV-28] DMS-REQ-0068-V-01: Raw Science Image Metadata }\label{lvv-28}
...
Requirement Description & \textbf{Specification:} For each raw science image, the DMS shall store
...
\item
  ...
  visit)
\end{itemize} \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} The program metadata should be sufficient to
...
appropriately allocated, and so that DMS-REQ-0320 can be satisfied. \\ \cdashline{1-2}
Requirement Priority & 1a \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
through an instance of the LSP
 ...
 \newpage \subsection{[LVV-29] DMS-REQ-0069-V-01: Processed Visit Images }\label{lvv-29}
...
Requirement Description & \textbf{Specification:} The DMS shall produce Processed Visit Images, in
...
Images obtained in pairs during a standard visit are combined. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} Processed science exposures are not archived, and
...
processing for Special Programs data is specific to each program. \\ \cdashline{1-2}
Requirement Priority & 1a \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0129 & Exposures (Level 1) \\
...
single ``meta-package'', lsst\_distrib.
 ...
 \newpage \subsection{[LVV-30] DMS-REQ-0070-V-01: Generate PSF for Visit Images }\label{lvv-30}
...
Requirement Description & \textbf{Specification:} The DMS shall determine a characterization of
the PSF for any specified location in Processed Visit Images. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0056 & System Monitoring \& Diagnostics \\
...
PSF given a point on the image.
 ...
 \newpage \subsection{[LVV-31] DMS-REQ-0072-V-01: Processed Visit Image Content }\label{lvv-31}
...
Requirement Description & \textbf{Specification:} Processed visit images shall include the
...
which photometric measurements can be derived. \\ \cdashline{1-2}
Requirement Priority & 1a \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0129 & Exposures (Level 1) \\
...
and a WCS model.
 ...
 \newpage \subsection{[LVV-33] DMS-REQ-0075-V-01: Catalog Queries }\label{lvv-33}
...
Requirement Description & \textbf{Specification:} The catalogs shall be queryable with a
structured language, such as SQL. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} Queries are expected to be generated via Science
...
query language of the DMS database server. \\ \cdashline{1-2}
Requirement Priority & 1a \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
these types of queries.
 ...
 \newpage \subsection{[LVV-38] DMS-REQ-0096-V-01: Generate Data Quality Report Within Specified Time }\label{lvv-38}

\begin{longtable}{ccccc}
\hline
\textbf{Jira Link} & \textbf{Assignee} & \textbf{Status} & \textbf{Priority} & \textbf{Test Cases}\\ \hline
\href{https://jira.lsstcorp.org/browse/LVV-38}{LVV-38} &
Simon Krughoff & Not Covered & 1a &
\begin{tabular}{c}
LVV-T103 \\
\end{tabular}
\\
...
Requirement Description & \textbf{Specification:} The DMS shall generate a nightly Data Quality
Report within time \textbf{dqReportComplTime} in both human-readable and
machine-readable forms. \\ \cdashline{1-2}
...
machine-readable formats.
 ...
 \newpage \subsection{[LVV-39] DMS-REQ-0097-V-01: Level 1 Data Quality Report Definition }\label{lvv-39}
...
Requirement Description & \textbf{Specification:} The DMS shall produce a Level 1 Data Quality
...
vs. mag for each utilized filter. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} The seeing report is intended as a broad-brush
measure of image quality. The PSF parameters provide more detail, as
they include asymmetries and field location dependence. \\ \cdashline{1-2}
Requirement Priority & 1a \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0131 & Nightly Summary Products \\
...
5. Detection efficiency
 ...
 \newpage \subsection{[LVV-41] DMS-REQ-0099-V-01: Level 1 Performance Report Definition }\label{lvv-41}
...
Requirement Description & \textbf{Specification:} The DMS shall produce a Level 1 Performance
...
satisfying the science criteria for each active science program. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
processing rather than the observatory system.
 ...
 \newpage \subsection{[LVV-43] DMS-REQ-0101-V-01: Level 1 Calibration Report Definition }\label{lvv-43}
...
Requirement Description & \textbf{Specification:} The DMS shall produce a Level 1 Calibration
...
including a nightly broad-band flat in each filter. \\ \cdashline{1-2}
Requirement Priority & 1a \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0131 & Nightly Summary Products \\
...
aspects of the telescope or camera are changing with time.
 ...
 \newpage \subsection{[LVV-46] DMS-REQ-0106-V-01: Coadded Image Provenance }\label{lvv-46}
...
Requirement Description & \textbf{Specification:} For each Coadded Image, DMS shall store: the
...
for users to re-create them in whole or in part. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} Not all coadded image types will be made available
to end-users or retained for the life of the survey; however, sufficient
metadata will be preserved so that they may be recreated by end-users. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0122 & Provenance \\
...
needed to exactly produce that coadd.
 ...
 \newpage \subsection{[LVV-48] DMS-REQ-0120-V-01: Level 3 Data Product Self Consistency }\label{lvv-48}
...
Requirement Description & \textbf{Specification:} The DMS shall provide a means for ensuring that
...
consistent Level 1 and Level 2 processings. \\ \cdashline{1-2}
Requirement Priority & 2 \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
sets of input data.
 ...
 \newpage \subsection{[LVV-49] DMS-REQ-0121-V-01: Provenance for Level 3 processing at DACs }\label{lvv-49}
...
Requirement Description & \textbf{Specification:} The DMS shall provide a means for recording
...
data from the EFD). \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} The DMS should also provide an optional means for
...
in being able to carry out their work in a reproducible way. \\ \cdashline{1-2}
Requirement Priority & 2 \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0122 & Provenance \\
...
user-generated Level 3 products.
 ...
 \newpage \subsection{[LVV-52] DMS-REQ-0124-V-01: Federation with external catalogs }\label{lvv-52}

\begin{longtable}{ccccc}
\hline
\textbf{Jira Link} & \textbf{Assignee} & \textbf{Status} & \textbf{Priority} & \textbf{Test Cases}\\ \hline
\href{https://jira.lsstcorp.org/browse/LVV-52}{LVV-52} &
Gregory Dubois-Felsmann & Not Covered & 2 &
\begin{tabular}{c}
LVV-T206 \\
\end{tabular}
\\
...
Requirement Description & \textbf{Specification:} The DMS shall provide a means for federating
...
the project lifetime. \\ \cdashline{1-2}
Requirement Priority & 2 \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
Verify that LSST-produced data can be combined with external datasets.
 ...
 \newpage \subsection{[LVV-57] DMS-REQ-0130-V-01: Calibration Data Products }\label{lvv-57}
...
Requirement Description & \textbf{Specification:} The DMS shall produce and archive Calibration
...
illumination correction frame per filter. \\ \cdashline{1-2}
Requirement Priority & 1a \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
DMS-REQ-0076 & Keep Science Data Archive \\
...
corrections.
 ...
 \newpage \subsection{[LVV-59] DMS-REQ-0132-V-01: Calibration Image Provenance }\label{lvv-59}
...
Requirement Description & \textbf{Specification:} For each Calibration Production data product,
...
Calibration Data Products.
 ...
 \newpage \subsection{[LVV-62] DMS-REQ-0158-V-01: Provide Pipeline Construction Services }\label{lvv-62}
...
Requirement Description &  \\ \cdashline{1-2}
Requirement Discussion & (This is a composite requirement in the SysML model, which simply
aggregates its children.) \\ \cdashline{1-2}
Requirement Priority & 1a \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
\end{tabular}
...
is a component of this test.
 ...
 \newpage \subsection{[LVV-64] DMS-REQ-0161-V-01: Optimization of Cost, Reliability and Availability in
Order }\label{lvv-64}
...
Requirement Description & \textbf{Specification:} Within a fixed cost envelope for the Data
Management subsystem, the allocation of processing and storage
facilities will optimize reliability over availability to end users. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
\end{tabular}
...
monitoring.
 ...
 \newpage \subsection{[LVV-96] DMS-REQ-0265-V-01: Guider Calibration Data Acquisition }\label{lvv-96}
...
Requirement Description & \textbf{Specification:} The DMS shall acquire raw, full-frame exposures
from the camera guider sensors during calibration. The DMS shall produce
calibration data products for the guide sensors. \\ \cdashline{1-2}
Requirement Priority & 1a \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0194 & Calibration Exposures Per Day \\
...
\end{itemize}
 ...
 \newpage \subsection{[LVV-97] DMS-REQ-0266-V-01: Exposure Catalog }\label{lvv-97}
...
Requirement Description & \textbf{Specification:} The DMS shall create an Exposure Catalog
...
location in the focal plane, electronic configuration, and WCS. \\ \cdashline{1-2}
Requirement Priority & 1a \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0130 & Catalogs (Level 1) \\
...
7. Per-sensor information
 ...
 \newpage \subsection{[LVV-98] DMS-REQ-0267-V-01: Source Catalog }\label{lvv-98}
...
Requirement Description & \textbf{Specification:} The DMS shall create a Catalog containing all
...
spaced in intensity. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0137 & Catalogs (Level 2) \\
...
single ``meta-package'', lsst\_distrib.
 ...
 \newpage \subsection{[LVV-99] DMS-REQ-0268-V-01: Forced-Source Catalog }\label{lvv-99}
...
Requirement Description & \textbf{Specification:} The DMS shall create a Forced-Source Catalog,
...
measurement quality flags. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} The large number of Forced Sources makes it
impractical to measure more attributes than are necessary to construct a
light curve for variability studies. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0137 & Catalogs (Level 2) \\
...
uncertainties, an Object ID, and a Visit ID.
 ...
 \newpage \subsection{[LVV-100] DMS-REQ-0269-V-01: DIASource Catalog }\label{lvv-100}
...
Requirement Description & \textbf{Specification:} The DMS shall construct a catalog of all Sources
...
and associated error for the source as measured on the Visit image. \\ \cdashline{1-2}
...
with the required attributes.
 ...
 \newpage \subsection{[LVV-101] DMS-REQ-0270-V-01: Faint DIASource Measurements }\label{lvv-101}

\begin{longtable}{ccccc}
\hline
\textbf{Jira Link} & \textbf{Assignee} & \textbf{Status} & \textbf{Priority} & \textbf{Test Cases}\\ \hline
\href{https://jira.lsstcorp.org/browse/LVV-101}{LVV-101} &
Eric Bellm & Not Covered & 2 &
\begin{tabular}{c}
LVV-T21 \\
LVV-T50 \\
\end{tabular}
...
Requirement Description & \textbf{Specification:} The DMS shall be able to measure and store
...
monitoring of DIA quality. \\ \cdashline{1-2}
Requirement Parameters & \textbf{transSNR = 5{{[}float{]}}} The signal-to-noise ratio in
single-visit difference images above which all optical transients are to
be reported. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} Some individual faint sources may be of high
significance, such as a potentially hazardous asteroid. \\ \cdashline{1-2}
Requirement Priority & 2 \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
below the nominal S/N cutoff that satisfy additional criteria.
 ...
 \newpage \subsection{[LVV-102] DMS-REQ-0271-V-01: Max nearby galaxies associated with DIASource }\label{lvv-102}
...
Requirement Description & \textbf{Specification:} The DMS shall construct a catalog of all
...
Object.
 ...
 \newpage \subsection{[LVV-103] DMS-REQ-0272-V-01: DIAObject Attributes }\label{lvv-103}
...
Requirement Description & \textbf{Specification:} For each DIAObject the DMS shall store summary
...
conditions encountered in measuring the above quantities. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0130 & Catalogs (Level 1) \\
...
including periodicity measures.
 ...
 \newpage \subsection{[LVV-104] DMS-REQ-0273-V-01: SSObject Catalog }\label{lvv-104}
...
Requirement Description & \textbf{Specification:} The DMS shall produce a catalog of all Solar
System Objects (SSObjects) that have been identified via Moving Object
...
errors, and flags that describe conditions of the description. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} The magnitude and angular velocity limits for
...
and acceptance criteria should be developed prior to verification. \\ \cdashline{1-2}
Requirement Priority & 2 \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0130 & Catalogs (Level 1) \\
...
additional related quanitites.
 ...
 \newpage \subsection{[LVV-105] DMS-REQ-0274-V-01: Alert Content }\label{lvv-105}
...
Requirement Description & \textbf{Specification:} The DMS shall create an Alert for each detected
...
and/or scheduler metadata. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} The aim for the Alert content is to include
...
Program (such as an in-progress Deep Drilling Field). \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0128 & Alerts \\
...
Verify that the context of the Alert packet match requirements.
 ...
 \newpage \subsection{[LVV-106] DMS-REQ-0275-V-01: Object Catalog }\label{lvv-106}
...
Requirement Description & \textbf{Specification:} The DMS shall create an Object Catalog, based on
...
and characterization. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0137 & Catalogs (Level 2) \\
...
images.
 ...
 \newpage \subsection{[LVV-107] DMS-REQ-0276-V-01: Object Characterization }\label{lvv-107}
...
Requirement Description & \textbf{Specification:} Each entry in the Object Catalog shall include
...
proper motion and parallax, and a variability characterization. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} These measurements are intended to enable LSST
``static sky'' science. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0137 & Catalogs (Level 2) \\
...
proper motion and parallax, and a variability characterization.
 ...
 \newpage \subsection{[LVV-108] DMS-REQ-0277-V-01: Coadd Source Catalog }\label{lvv-108}
...
Requirement Description & \textbf{Specification:} The DMS shall, in the course of creating the
master Source Catalog, create a catalog from the coadds of all sources
detected in each passband with a SNR \textgreater{}
\textbf{coaddDetectThresh}. \\ \cdashline{1-2}
...
Requirement Discussion & \textbf{Discussion:} CoaddSources are in general composites of
...
released to end-users. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0137 & Catalogs (Level 2) \\
...
\end{longtable}
 ...
 \newpage \subsection{[LVV-109] DMS-REQ-0278-V-01: Coadd Image Method Constraints }\label{lvv-109}
...
Requirement Description & \textbf{Specification:} Coadd Images shall be created by combining
...
astrophysical background. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} It is expected that coadded images will be produced
for all observed regions of the sky, not just the main survey area. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0136 & Co-added Exposures \\
...
Verify the implementation of how Coadd images are created.
 ...
 \newpage \subsection{[LVV-110] DMS-REQ-0279-V-01: Deep Detection Coadds }\label{lvv-110}
...
Requirement Description & \textbf{Specification:} The DMS shall periodicaly create Co-added Images
...
specified quality conditions. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} Quality attributes may include thresholds on
seeing, sky brightness, wavefront quality, PSF shape and spatial
variability, or date of exposure. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0136 & Co-added Exposures \\
...
that are optimized for depth.
 ...
 \newpage \subsection{[LVV-111] DMS-REQ-0280-V-01: Template Coadds }\label{lvv-111}
...
Requirement Description & \textbf{Specification:} The DMS shall periodically create Template
...
available. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} Image Templates are used by the Image Difference
...
built with at least three images. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
Verify that the DMS can produce Template Coadds for DIA processing.
 ...
 \newpage \subsection{[LVV-112] DMS-REQ-0281-V-01: Multi-band Coadds }\label{lvv-112}
...
Requirement Description & \textbf{Specification:} The DMS shall periodically create Multi-band
Coadd images which are constructed similarly to Deep Detection Coadds,
but where all passbands are combined. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} The multi-color Coadds are intended for very deep
detection. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0136 & Co-added Exposures \\
...
purposes.
 ...
 \newpage \subsection{[LVV-113] DMS-REQ-0282-V-01: Dark Current Correction Frame Creation }\label{lvv-113}
...
science data. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} The need for a dark current correction will have to
...
detectors, even if not used in calibration processing. \\ \cdashline{1-2}
Requirement Priority & 1a \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0271 & Supported Image Types \\
...
product.
 ...
 \newpage \subsection{[LVV-114] DMS-REQ-0283-V-01: Fringe Correction Frame }\label{lvv-114}
...
data. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} Fringing is likely to affect only the reddest
...
fringe-correction frame and determine how often it should be updated.
 ...
 \newpage \subsection{[LVV-116] DMS-REQ-0285-V-01: Level 1 Source Association }\label{lvv-116}
...
Requirement Description & \textbf{Specification:} The DMS shall associate clusters of DIASources
detected on multiple visits taken at different times with either a
DIAObject or an SSObject. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} The association will represent the underlying
astrophysical phenomenon. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0130 & Catalogs (Level 1) \\
...
Test completeness of orbit association using simulated data
 ...
 \newpage \subsection{[LVV-117] DMS-REQ-0286-V-01: SSObject Precovery }\label{lvv-117}
...
Requirement Description & \textbf{Specification:} Upon identifying a new SSObject, the DMS shall
associate additional DIAObjects that are consistent with the orbital
parameters (precovery), and update DIAObject entries so associated. \\ \cdashline{1-2}
Requirement Priority & 2 \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0159 & Level 1 Moving Object Quality \\
...
back in time) with objects classified as SSObjects.
 ...
 \newpage \subsection{[LVV-118] DMS-REQ-0287-V-01: Max look-back time for precovery }\label{lvv-118}

\begin{longtable}{ccccc}
\hline
\textbf{Jira Link} & \textbf{Assignee} & \textbf{Status} & \textbf{Priority} & \textbf{Test Cases}\\ \hline
\href{https://jira.lsstcorp.org/browse/LVV-118}{LVV-118} &
Eric Bellm & Not Covered & Undefined &
\begin{tabular}{c}
LVV-T110 \\
\end{tabular}
\\
...
Requirement Description & \textbf{Specification:} For all DIASources not associated with either
...
publicly available within \textbf{L1PublicT}. \\ \cdashline{1-2}
...
Requirement Discussion & \textbf{Discussion:} The \textbf{precoveryWindow} is intended to satisfy
...
l*1CacheLifetime*. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0130 & Catalogs (Level 1) \\
...
available images within the precoveryWindow.
 ...
 \newpage \subsection{[LVV-119] DMS-REQ-0288-V-01: Use of External Orbit Catalogs }\label{lvv-119}
...
Requirement Description & \textbf{Specification:} It shall be possible for DMS to make use of
...
transient Alert stream in nightly processing. \\ \cdashline{1-2}
Requirement Priority & 2 \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0159 & Level 1 Moving Object Quality \\
...
identification of SSObjects.
 ...
 \newpage \subsection{[LVV-120] DMS-REQ-0289-V-01: Calibration Production Processing }\label{lvv-120}
...
Requirement Description & \textbf{Specification:} The DMS shall be capable of producing
...
calibrations, and of the SRD requirements for calibration accuracy. \\ \cdashline{1-2}
Requirement Priority & 1a \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
calibration pipeline correctly produces necessary calibration products.
 ...
 \newpage \subsection{[LVV-121] DMS-REQ-0290-V-01: Level 3 Data Import }\label{lvv-121}
...
Requirement Description & \textbf{Specification:} The DMS shall be able to ingest tables from
...
production of Level-3 data products. \\ \cdashline{1-2}
Requirement Priority & 2 \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0140 & Production \\
...
file formats.
 ...
 \newpage \subsection{[LVV-122] DMS-REQ-0291-V-01: Query Repeatability }\label{lvv-122}
...
Requirement Description & \textbf{Specification:} The DMS shall ensure that any query executed at
...
processing). \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} It would be desirable to have the ability to
...
without requiring a large copy and paste. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0181 & Data Products Query and Download Infrastructure \\
...
new additional data for live (Alert Production) databases.
 ...
 \newpage \subsection{[LVV-123] DMS-REQ-0292-V-01: Uniqueness of IDs Across Data Releases }\label{lvv-123}
...
Requirement Description & \textbf{Specification:} To reduce the likelihood for confusion, all IDs
...
exposures). \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} For example, DR4 and DR5 (or any other) release
will share no identical Object, Source, DIAObject or DIASource IDs. \\ \cdashline{1-2}
Requirement Priority & 1a \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0130 & Catalogs (Level 1) \\
...
different Data Releases are unique.
 ...
 \newpage \subsection{[LVV-124] DMS-REQ-0293-V-01: Selection of Datasets }\label{lvv-124}
...
Requirement Description & \textbf{Specification:} A Dataset may consist of one or more pixel
...
processing. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} Logical groupings might be pairs of Exposures in a
Visit, along with supporting metadata and provenance information, or
might be groupings defined in the context of Level-3 processing. \\ \cdashline{1-2}
Requirement Priority & 1a \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0176 & Data Access \\
...
groupings that are processed or produced as a logical unit.
 ...
 \newpage \subsection{[LVV-125] DMS-REQ-0294-V-01: Processing of Datasets }\label{lvv-125}
...
Requirement Description & \textbf{Specification:} The DMS shall process all requested datasets
...
further processing. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} The criteria may be specified by DMS processing
software, or by a scientist end-user for Level-3 production. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0120 & Consistency \\
...
Execute AP and DRP, simulate failures, observe correct processing
 ...
 \newpage \subsection{[LVV-127] DMS-REQ-0296-V-01: Pre-cursor, and Real Data }\label{lvv-127}
...
Requirement Description & \textbf{Specification:} The DMS shall provide for the ability to process
data from other electronic, pixel-oriented astronomical imaging cameras. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} A comparison of DMS products to that produced by
similar systems for other cameras provides an essential validation of
DMS algorithms and techniques. \\ \cdashline{1-2}
Requirement Priority & 1a \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
\end{tabular}
...
single ``meta-package'', lsst\_distrib.
 ...
 \newpage \subsection{[LVV-130] DMS-REQ-0299-V-01: Data Product Ingest }\label{lvv-130}
...
Requirement Description & \textbf{Specification:} The DMS shall provide software to ingest data
products into the Science Data Archive. \\ \cdashline{1-2}
Requirement Priority & 1a \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
\end{itemize}
 ...
 \newpage \subsection{[LVV-132] DMS-REQ-0301-V-01: Control of Level-1 Production }\label{lvv-132}
...
Requirement Description & \textbf{Specification:} The DMS shall contain a component to control all
Level-1 Data Product production. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} This specifically addresses the need to control the
Alert Production across all DMS facilities. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
facilities.
 ...
 \newpage \subsection{[LVV-138] DMS-REQ-0307-V-01: Unique Processing Coverage }\label{lvv-138}
...
Requirement Description & \textbf{Specification:} The DMS shall enable applications to process
...
some readers and would benefit from clarification in the discussion. \\ \cdashline{1-2}
Requirement Priority & 2 \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0120 & Consistency \\
...
record in a table exactly once.
 ...
 \newpage \subsection{[LVV-142] DMS-REQ-0311-V-01: Regenerate Un-archived Data Products }\label{lvv-142}
...
Requirement Description & \textbf{Specification:} The DMS shall be able to regenerate unarchived
data products to within scientifically reasonable tolerances. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} Unarchived data products currently include
...
to change (and improve) during the course of the survey. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0129 & Exposures (Level 1) \\
...
from an archived data release after the fact.
 ...
 \newpage \subsection{[LVV-148] DMS-REQ-0317-V-01: DIAForcedSource Catalog }\label{lvv-148}
...
Requirement Description & \textbf{Specification:} The DMS shall create a DIAForcedSource Catalog,
...
flags. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} The large number of such forced sources makes it
impractical to measure more attributes than are necessary to construct a
light curve for variability studies. \\ \cdashline{1-2}
Requirement Priority & 2 \\ \cdashline{1-2}
Upper Level Requirement &
...
catalog contains measured fluxes for DIAObjects.
 ...
 \newpage \subsection{[LVV-150] DMS-REQ-0319-V-01: Characterizing Variability }\label{lvv-150}
...
Requirement Description & \textbf{Specification:} For alert production, DIAObject variability
...
Requirement Discussion & \textbf{Discussion:} These measurements can come from the live L1
database. For level 1 processing during Data Release Production, all
data should be used for characterization. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
period of time.
 ...
 \newpage \subsection{[LVV-152] DMS-REQ-0321-V-01: Level 1 Processing of Special Programs Data }\label{lvv-152}

\begin{longtable}{ccccc}
\hline
\textbf{Jira Link} & \textbf{Assignee} & \textbf{Status} & \textbf{Priority} & \textbf{Test Cases}\\ \hline
\href{https://jira.lsstcorp.org/browse/LVV-152}{LVV-152} &
Melissa Graham & Not Covered & 2 &
\begin{tabular}{c}
LVV-T93 \\
\end{tabular}
\\
...
Requirement Description & \textbf{Specification:} All Level 1 processing from special programs
shall be completed before data arrives from the following night's
observations. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} Only Special Programs data that can be incorporated
...
processing has completed before the start of the next simulated night.~
 ...
 \newpage \subsection{[LVV-154] DMS-REQ-0323-V-01: Calculating SSObject Parameters }\label{lvv-154}

\begin{longtable}{ccccc}
\hline
\textbf{Jira Link} & \textbf{Assignee} & \textbf{Status} & \textbf{Priority} & \textbf{Test Cases}\\ \hline
\href{https://jira.lsstcorp.org/browse/LVV-154}{LVV-154} &
Eric Bellm & Not Covered & 3 &
\begin{tabular}{c}
LVV-T57 \\
\end{tabular}
\\
...
Requirement Description & \textbf{Specification:} The LSST database shall provide functions to
compute, for every SSObject, the phase angle for every observation, and
the reduced and absolute asteroid magnitudes in all LSST bands. \\ \cdashline{1-2}
...
and magnitudes in LSST bands for every SSObject.
 ...
 \newpage \subsection{[LVV-155] DMS-REQ-0324-V-01: Matching DIASources to Objects }\label{lvv-155}
...
Requirement Description & \textbf{Specification:} A L1 DIASource to L2 Object positional
cross-match table or database view shall be made available. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} Care should be taken to note that this is purely a
cross-match based on separation on the sky and does not imply the
DIASource and Object are physically the same. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0126 & Level 1 Data Products \\
...
Objects.
 ...
 \newpage \subsection{[LVV-156] DMS-REQ-0325-V-01: Regenerating L1 Data Products During Data Release
...
Requirement Description & \textbf{Specification:} During Data Release Processing, all the Level 1
data products shall be regenerated using the current best algorithms. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} Variability characterization will use the full
light curve history. \\ \cdashline{1-2}
Requirement Priority & 2 \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
DRP.
 ...
 \newpage \subsection{[LVV-157] DMS-REQ-0326-V-01: Storing Approximations of Per-pixel Metadata }\label{lvv-157}
...
Requirement Description & \textbf{Specification:} Image depth and mask information shall be
available in a parametrized approximate form in addition to a full
per-pixel form. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} This parametrization could be in formats such as
...
maps providing additional information as a function of sky position. \\ \cdashline{1-2}
Requirement Priority & 2 \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
information.
 ...
 \newpage \subsection{[LVV-158] DMS-REQ-0327-V-01: Background Model Calculation }\label{lvv-158}
...
Requirement Description & \textbf{Specification:} The DMS shall derive and persist a background
model (both due to night sky and astrophysical) for each visit image,
per CCD. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0056 & System Monitoring \& Diagnostics \\
...
to be retrieved along with the image for that CCD.
 ...
 \newpage \subsection{[LVV-159] DMS-REQ-0328-V-01: Documenting Image Characterization }\label{lvv-159}
...
Requirement Description & \textbf{Specification:} The persisted format for Processed Visit Images
shall be fully documented, and shall include a description of all image
characterization data products. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} This will allow the community to use them to
increase understanding of LSST images and derived LSST catalogs. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0391 & Data Product Conventions \\
...
associated instrument-signature-removal data products is documented.
 ...
 \newpage \subsection{[LVV-160] DMS-REQ-0329-V-01: All-Sky Visualization of Data Releases }\label{lvv-160}
...
Requirement Description & \textbf{Specification:} Data Release Processing shall generate co-adds
suitable for use in all-sky visualization tools, allowing panning and
zooming of the entire data release. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} For example, this could mean HEALPix tiles suitable
for use in a HiPS server. The exact technology choice has to be
confirmed before understanding which format is required. \\ \cdashline{1-2}
Requirement Priority & 2 \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0136 & Co-added Exposures \\
...
Release data products.
 ...
 \newpage \subsection{[LVV-161] DMS-REQ-0330-V-01: Best Seeing Coadds }\label{lvv-161}
...
Requirement Description & \textbf{Specification:} Best seeing coadds shall be made for each band
(including multi-color). \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} DMS-REQ-0279 states that seeing-based co-adds
should be possible. This requirement states that they shall be made. \\ \cdashline{1-2}
Requirement Priority & 2 \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0136 & Co-added Exposures \\
...
coadd.
 ...
 \newpage \subsection{[LVV-162] DMS-REQ-0331-V-01: Computing Derived Quantities }\label{lvv-162}
...
Requirement Description & \textbf{Specification:} Common derived quantities shall be made
...
color-color diagrams. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} Example quantities include those used to assess
...
derived data, or generating other common scientific derivatives.
 ...
 \newpage \subsection{[LVV-163] DMS-REQ-0332-V-01: Denormalizing Database Tables }\label{lvv-163}
...
Requirement Description & \textbf{Specification:} The database tables shall contain views
presented to the users that will be appropriately denormalized for ease
of use. \\ \cdashline{1-2}
Requirement Priority & 2 \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0133 & Level 2 Data Products \\
...
Science Platform.
 ...
 \newpage \subsection{[LVV-164] DMS-REQ-0333-V-01: Maximum Likelihood Values and Covariances }\label{lvv-164}
...
Requirement Description & \textbf{Specification:} Quantities delivered by all measurement
algorithms shall include maximum likelihood values and covariances. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} Algorithms for which such values are impossible,
will be documented explicitly to declare that the values are
unavailable. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0391 & Data Product Conventions \\
...
\end{itemize}
 ...
 \newpage \subsection{[LVV-166] DMS-REQ-0335-V-01: PSF-Matched Coadds }\label{lvv-166}
...
Requirement Description & \textbf{Specification:} One (ugrizy plus multi-band) set of PSF-matched
coadds shall be made but shall not be archived. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} These are used to measure colors and shapes of
...
Verify that the DRP pipelines produce PSF matched coadds.
 ...
 \newpage \subsection{[LVV-167] DMS-REQ-0336-V-01: Regenerating Data Products from Previous Data
...
Requirement Description & \textbf{Specification:} The DMS shall be able to regenerate data
products from previous data releases to within scientifically reasonable
tolerances. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} This is similar to DMS-REQ-0311, but covering prior
...
software having to be ported to a modern operating system. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
generated using through the LSST Science Platform.
 ...
 \newpage \subsection{[LVV-168] DMS-REQ-0337-V-01: Detecting faint variable objects }\label{lvv-168}
...
Requirement Description & \textbf{Specification:} The DMS shall be able to detect faint objects
showing long-term variability, or nearby object with high proper
motions. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} For example, this could be implemented using
short-period (yearly) coadds. \\ \cdashline{1-2}
Requirement Priority & 2 \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0136 & Co-added Exposures \\
...
months).
 ...
 \newpage \subsection{[LVV-169] DMS-REQ-0338-V-01: Targeted Coadds }\label{lvv-169}

\begin{longtable}{ccccc}
\hline
\textbf{Jira Link} & \textbf{Assignee} & \textbf{Status} & \textbf{Priority} & \textbf{Test Cases}\\ \hline
\href{https://jira.lsstcorp.org/browse/LVV-169}{LVV-169} &
Robert Lupton & Not Covered & 2 &
\begin{tabular}{c}
LVV-T81 \\
\end{tabular}
\\
...
Requirement Description & \textbf{Specification:} It shall be possible to retain small sections of
all generated coadds. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} This supports quality assessment and targeted
science. \\ \cdashline{1-2}
Requirement Priority & 2 \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
can be retained, even if the full coadd is not.
 ...
 \newpage \subsection{[LVV-170] DMS-REQ-0339-V-01: Tracking Characterization Changes Between Data
...
Requirement Description & \textbf{Specification:} Small, overlapping, samples of data from older
releases shall be kept loaded in the database. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} This enables a comparison of how current data
releases relate to previous data releases and to improve data quality
monitoring. \\ \cdashline{1-2}
Requirement Priority & 1a \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
LSR-REQ-0040 & Data Quality Monitoring \\
...
DR is retired, for comparison with future DRs.
 ...
 \newpage \subsection{[LVV-178] DMS-REQ-0347-V-01: Measurements in catalogs }\label{lvv-178}
...
Requirement Description & \textbf{Specification:} All catalogs shall record source measurements in
flux units. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} Difference measurements can go negative and in
...
where appropriate. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0391 & Data Product Conventions \\
...
\begin{longtable}{p{3cm}p{2.5cm}p{2.5cm}p{3cm}p{4cm}}
\toprule
\href{https://jira.lsstcorp.org/secure/Tests.jspa\#/testCase/LVV-T28}{LVV-T28} & \multicolumn{4}{p{12cm}}{ Verify implementation of Measurements in catalogs } \\ \hline
\textbf{Owner} & \textbf{Status} & \textbf{Version} & \textbf{Critical Event} & \textbf{Verification Type} \\ \hline
...
Verify that source measurements in catalogs are in flux units.
 ...
 \newpage \subsection{[LVV-179] DMS-REQ-0348-V-01: Pre-defined alert filters }\label{lvv-179}
...
Requirement Description & \textbf{Specification:} Users of the LSST Alert Filtering Service shall
be able to use a predefined set of simple filters. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} See LSR-REQ-0026 \\ \cdashline{1-2}
Requirement Priority & 2 \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
\end{itemize}
 ...
 \newpage \subsection{[LVV-180] DMS-REQ-0349-V-01: Detecting extended low surface brightness objects }\label{lvv-180}
...
Requirement Description & \textbf{Specification:} It shall be possible to detect extended low
surface brightness objects in coadds. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} For example, this could be done by using the binned
detection algorithm from SDSS. \\ \cdashline{1-2}
Requirement Priority & 2 \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0133 & Level 2 Data Products \\
...
S/N is lower than the detection threshold) are detected in coadds.
 ...
 \newpage \subsection{[LVV-181] DMS-REQ-0350-V-01: Associating Objects across data releases }\label{lvv-181}
...
Requirement Description & \textbf{Specification:} It shall be possible to associate an Object in
...
releases being online. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} This could be done with a database table mapping
every Object in one data release to the matched Object in every other
data release. \\ \cdashline{1-2}
Requirement Priority & 2 \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
\end{tabular}
...
Load DR, observe queryable association
 ...
 \newpage \subsection{[LVV-182] DMS-REQ-0351-V-01: Provide Beam Projector Coordinate Calculation
...
Requirement Description & \textbf{Specification:} The DMS shall provide software to represent the
...
the telescope optical elements and focal plane. \\ \cdashline{1-2}
Requirement Priority & 1a \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
plane.
 ...
 \newpage \subsection{[LVV-3399] DMS-REQ-0378-V-01: Simultaneous Image Access Performance }\label{lvv-3399}
...
Requirement Description & \textbf{Specification:} All the enclosed performance metrics shall be
met simultaneously. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} While these image access requirements specify
...
available capacity. \\ \cdashline{1-2}
Requirement Priority & 2 \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0181 & Data Products Query and Download Infrastructure \\
...
\end{longtable}
 ...
 \newpage \subsection{[LVV-3401] DMS-REQ-0359-V-01: RMS photometric repeatability in uzy }\label{lvv-3401}
...
Requirement Description & \textbf{Specification:} The DMS shall include software to enable the
calculation of the photometric performance metrics defined in
OSS-REQ-0387. \\ \cdashline{1-2}
...
Requirement Discussion & \textbf{Discussion:} The relevant metrics are listed in the table
photometricPerformance below. The values in the tables are the target
values for LSST but are not verified as part of this requirement. \\ \cdashline{1-2}
Requirement Priority & 1a \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
millimagnitudes}.
 ...
 \newpage \subsection{[LVV-3402] DMS-REQ-0360-V-01: Median astrometric error on 20 arcmin scales }\label{lvv-3402}
...
Requirement Discussion & \textbf{Discussion:} The relevant metrics are listed in the table below.
The values in the tables are the target values for LSST but are not
verified as part of this requirement. \\ \cdashline{1-2}
Requirement Priority & 1a \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
milliarcseconds.
 ...
 \newpage \subsection{[LVV-3404] DMS-REQ-0362-V-01: Median residual PSF ellipticity correlations on 5
...
OSS-REQ-0403, OSS-REQ-0404, and OSS-REQ-0405. \\ \cdashline{1-2}
...
1.0e-7{[}arcminuteSeparationCorrelation{]}.}
 ...
 \newpage \subsection{[LVV-5640] DM-TS-CON-ICD-0011-V-01: Data Format\_DM\_1 }\label{lvv-5640}
...
Requirement Description & \textbf{Specification}: The WCS solution published by Data Management
...
matrix (four doubles). \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion}: DM does not calculate the WCS for the wavefront
...
detectors as wavefront sensors. \\ \cdashline{1-2}
...
\end{longtable}
 ...
 \newpage \subsection{[LVV-5641] DM-TS-CON-ICD-0011-V-02: Data Format\_DM\_2 }\label{lvv-5641}
...
\end{longtable}
 ...
 \newpage \subsection{[LVV-5646] DM-TS-CON-ICD-0002-V-01: Timing\_DM\_1 }\label{lvv-5646}
...
Requirement Description & \textbf{Specification:} Data Management shall provide, for each
...
data acquisition for the visit. \\ \cdashline{1-2}
...
Requirement Discussion & \textbf{Discussion:} The T\&S~and commissioning teams express the need
...
\end{longtable}
 ...
 \newpage \subsection{[LVV-5647] DM-TS-CON-ICD-0002-V-02: Timing\_DM\_2 }\label{lvv-5647}
...
\end{longtable}
 ...
 \newpage \subsection{[LVV-9741] DMS-REQ-0030-V-02: Minimum astrometric standards per CCD }\label{lvv-9741}
...
standards.
 ...
 \newpage \subsection{[LVV-9743] DMS-REQ-0271-V-03: Radius considered nearby }\label{lvv-9743}
...
\end{longtable}
 ...
 \newpage \subsection{[LVV-9745] DMS-REQ-0131-V-02: Max number of calibs to be processed }\label{lvv-9745}
...
Requirement Description & \textbf{Specification:} Calibration products from a group of up to
...
Requirement Discussion & \textbf{Discussion:} The motivation here is that calibration images will
...
can be processed together within time calProcTime.
 ...
 \newpage \subsection{[LVV-9746] DMS-REQ-0287-V-02: Max time from acquisition to L1 data release }\label{lvv-9746}
...
\end{longtable}
 ...
 \newpage \subsection{[LVV-9747] DMS-REQ-0287-V-03: Lifetime of archived L1 data products }\label{lvv-9747}
...
\end{longtable}
 ...
 \newpage \subsection{[LVV-9751] DMS-REQ-0359-V-02: Max fraction of sensors with excess unusable pixels }\label{lvv-9751}
...
than~\textbf{SensorFraction = 15 percent.}
 ...
 \newpage \subsection{[LVV-9752] DMS-REQ-0359-V-03: Max fraction of outliers among non-saturated sources }\label{lvv-9752}
...
of \textbf{PA2gri = 15 millimagnitudes}.
 ...
 \newpage \subsection{[LVV-9753] DMS-REQ-0359-V-04: Accuracy of zero point for colors with u-band }\label{lvv-9753}
...
\textbf{PA5u = 10 millimagnitudes}.
 ...
 \newpage \subsection{[LVV-9754] DMS-REQ-0359-V-05: Repeatability outlier limit in gri }\label{lvv-9754}
...
of \textbf{PA2gri = 15 millimagnitudes}.
 ...
 \newpage \subsection{[LVV-9755] DMS-REQ-0359-V-06: Accuracy of photometric transformation }\label{lvv-9755}
...
millimagnitudes}.
 ...
 \newpage \subsection{[LVV-9756] DMS-REQ-0359-V-07: RMS width of zero point in u-band }\label{lvv-9756}
...
millimagnitudes}.
 ...
 \newpage \subsection{[LVV-9757] DMS-REQ-0359-V-08: Max cross-talk imperfections }\label{lvv-9757}
...
crosstalk corrections is less than \textbf{Xtalk = 3 sigma}.
 ...
 \newpage \subsection{[LVV-9758] DMS-REQ-0359-V-09: Repeatability outlier limit in uzy }\label{lvv-9758}
...
of \textbf{PA2uzy = 22.5 millimagnitudes}.~
 ...
 \newpage \subsection{[LVV-9759] DMS-REQ-0359-V-10: RMS photometric repeatability in gri }\label{lvv-9759}
...
millimagnitudes}.
 ...
 \newpage \subsection{[LVV-9760] DMS-REQ-0359-V-11: Fraction of zero point outliers }\label{lvv-9760}
...
confirm that it is less than \textbf{PF2 = 10 percent.}
 ...
 \newpage \subsection{[LVV-9761] DMS-REQ-0359-V-12: Max fraction of unusable pixels per sensor }\label{lvv-9761}
...
than~\textbf{PixFrac = 1 percent}.
 ...
 \newpage \subsection{[LVV-9762] DMS-REQ-0359-V-13: Max sky brightness error }\label{lvv-9762}
...
less than \textbf{SBPrec = 1 percent.}
 ...
 \newpage \subsection{[LVV-9763] DMS-REQ-0359-V-14: RMS width of zero point in all bands except u }\label{lvv-9763}
...
10 millimagnitudes}.
 ...
 \newpage \subsection{[LVV-9764] DMS-REQ-0359-V-15: Percentage of image area with ghosts }\label{lvv-9764}
...
\textbf{GhostAF = 1 percent}.
 ...
 \newpage \subsection{[LVV-9765] DMS-REQ-0359-V-16: Accuracy of zero point for colors without u-band }\label{lvv-9765}
...
millimagnitudes}.
 ...
 \newpage \subsection{[LVV-9766] DMS-REQ-0359-V-17: Max RMS of resolved/unresolved flux ratio }\label{lvv-9766}
...
\textbf{ResSource = 2}.
 ...
 \newpage \subsection{[LVV-9767] DMS-REQ-0360-V-02: Max fraction exceeding limit on 5 arcmin scales }\label{lvv-9767}
...
\textbf{AF1 = 10 percent.}
 ...
 \newpage \subsection{[LVV-9768] DMS-REQ-0360-V-03: Median astrometric error on 5 arcmin scales }\label{lvv-9768}
...
than\textbf{~\textbf{AM1 = 10 milliarcseconds.}}
 ...
 \newpage \subsection{[LVV-9769] DMS-REQ-0360-V-04: Median absolute error in RA, Dec }\label{lvv-9769}
...
milliarcseconds}.
 ...
 \newpage \subsection{[LVV-9770] DMS-REQ-0360-V-05: Outlier limit on 20 arcmin scales }\label{lvv-9770}
...
shall be less than \textbf{AF2 = 10 percent.}
 ...
 \newpage \subsection{[LVV-9771] DMS-REQ-0360-V-06: Color difference outlier limit relative to r-band }\label{lvv-9771}
...
= 10 percent.~}
 ...
 \newpage \subsection{[LVV-9773] DMS-REQ-0360-V-07: Outlier limit on 5 arcmin scales }\label{lvv-9773}
...
\textbf{AF1 = 10 percent.}
 ...
 \newpage \subsection{[LVV-9774] DMS-REQ-0360-V-08: Median astrometric error on 200 arcmin scales }\label{lvv-9774}
...
AM3 = 15 milliarcseconds.
 ...
 \newpage \subsection{[LVV-9775] DMS-REQ-0360-V-09: Outlier limit on 200 arcmin scales }\label{lvv-9775}
...
the metrics), we verify all of the requirements via a single test case.
 ...
 \newpage \subsection{[LVV-9776] DMS-REQ-0360-V-10: Max fraction exceeding limit on 20 arcmin scales }\label{lvv-9776}
...
shall be less than \textbf{AF2 = 10 percent.}
 ...
 \newpage \subsection{[LVV-9777] DMS-REQ-0360-V-11: Max fraction of r-band color difference outliers }\label{lvv-9777}
...
= 10 percent.~}
 ...
 \newpage \subsection{[LVV-9778] DMS-REQ-0360-V-12: RMS difference between r-band and other filter
...
10~milliarcseconds.}
 ...
 \newpage \subsection{[LVV-9779] DMS-REQ-0360-V-13: Max fraction exceeding limit on 200 arcmin scales }\label{lvv-9779}
...
shall be less than \textbf{AF3 = 10 percent.}
 ...
 \newpage \subsection{[LVV-9780] DMS-REQ-0362-V-02: Max fraction of excess ellipticity residuals on 1 and
...
ellipticity residuals and correlation metrics defined in the OSS.~
 ...
 \newpage \subsection{[LVV-9781] DMS-REQ-0362-V-03: Outlier limit on 5 arcmin scales - ellipticity }\label{lvv-9781}
...
\end{longtable}
 ...
 \newpage \subsection{[LVV-9782] DMS-REQ-0362-V-04: Median residual PSF ellipticity correlations on 1
...
2.0e-5{[}arcminuteSeparationCorrelation{]}.}
 ...
 \newpage \subsection{[LVV-9783] DMS-REQ-0362-V-05: Outlier limit on 1 arcmin scales }\label{lvv-9783}
...
\end{longtable}
 ...
 \newpage \subsection{[LVV-9867] DMS-PRTL-REQ-0025-V-01: Positional Query: Solar System Object Names\_1 }\label{lvv-9867}

\begin{longtable}{ccccc}
\hline
\textbf{Jira Link} & \textbf{Assignee} & \textbf{Status} & \textbf{Priority} & \textbf{Test Cases}\\ \hline
\href{https://jira.lsstcorp.org/browse/LVV-9867}{LVV-9867} &
Gregory Dubois-Felsmann & Not Covered & Undefined &
\begin{tabular}{c}
LVV-T660 \\
\end{tabular}
\\
...
Requirement Description & The Portal aspect shall support positional queries based on external
...
specification. \\ \cdashline{1-2}
Requirement Discussion & The intent here is to enable a user to enter a solar system object name
...
spatially and temporally organized, e.g., Visit or DIASource. \\ \cdashline{1-2}
Requirement Priority &  \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
\end{tabular}
...
a given Solar System object name.
 ...
 \newpage \subsection{[LVV-9869] DMS-PRTL-REQ-0026-V-01: Positional Query by Region: Cone-Search\_1 }\label{lvv-9869}
...
Requirement Description & The Portal aspect shall support position-based queries based on a
cone-shaped radial search. \\ \cdashline{1-2}
Requirement Priority &  \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
\end{tabular}
...
level of partial capability during construction.
 ...
 \newpage \subsection{[LVV-9926] DMS-PRTL-REQ-0085-V-01: Distance Measurement Tool\_1 }\label{lvv-9926}
...
Requirement Description & The Portal aspect shall have the capability to determine the distance
...
performed in spherical geometry where appropriate. \\ \cdashline{1-2}
Requirement Discussion & The point behind this requirement is to enable distance determinations
...
be performed in spherical geometry where appropriate.
 ...
 \newpage \subsection{[LVV-9937] DMS-PRTL-REQ-0097-V-01: Statistical Measurements on Image Data\_1 }\label{lvv-9937}
...
Requirement Description & The Portal aspect shall enable the capability to perform a set of
statistical measurements (e.g., mean, median, RMS, skew, kurtosis) on
user-selected regions in images. \\ \cdashline{1-2}
Requirement Priority &  \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
\end{tabular}
...
user-selected regions in images.
 ...
 \newpage \subsection{[LVV-18225] DMS-REQ-0382-V-01: HiPS Visualization\_1 }\label{lvv-18225}

\begin{longtable}{ccccc}
\hline
\textbf{Jira Link} & \textbf{Assignee} & \textbf{Status} & \textbf{Priority} & \textbf{Test Cases}\\ \hline
\href{https://jira.lsstcorp.org/browse/LVV-18225}{LVV-18225} &
Leanne Guy & Not Covered & 1b &
\begin{tabular}{c}
LVV-T1527 \\
\end{tabular}
\\
...
Requirement Description & \textbf{Specification:} The LSST Science Platform shall support the
...
coadd tiles). \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} Further details will be provided in the LSST
Science Platform Requirements, \citeds{LDM-554}. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
that provided for individual source images (e.g., PVIs and coadd tiles).
 ...
 \newpage \subsection{[LVV-18227] DMS-REQ-0379-V-01: Produce All-Sky HiPS Map\_1 }\label{lvv-18227}
...
Requirement Description & \textbf{Specification:} Data Release Production shall include the
...
map, following the IVOA HiPS Recommendation. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} The maximum resolution of the image maps is TBD;
...
question as to whether HiPS maps will be generated for those fields. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0391 & Data Product Conventions \\
...
the IVOA HiPS Recommendation.
 ...
 \newpage \subsection{[LVV-18228] DMS-REQ-0383-V-01: Produce MOC Maps\_1 }\label{lvv-18228}
...
on-sky data. \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} It is likely to be useful to produce quite a large
...
scale.\\
The Project should produce a technical note, during the construction
era, detailing the specific plans for creation of MOCs. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0391 & Data Product Conventions \\
...
data.
 ...
 \newpage \subsection{[LVV-18229] DMS-REQ-0344-V-01: Time to L1 public release }\label{lvv-18229}

\begin{longtable}{ccccc}
\hline
\textbf{Jira Link} & \textbf{Assignee} & \textbf{Status} & \textbf{Priority} & \textbf{Test Cases}\\ \hline
\href{https://jira.lsstcorp.org/browse/LVV-18229}{LVV-18229} &
Melissa Graham & Not Covered & Undefined &
\begin{tabular}{c}
LVV-T1865 \\
\end{tabular}
\\
...
Requirement Description & \textbf{Specification:} The publishing of Level 1 data products from
...
science data.
 ...
 \newpage \subsection{[LVV-18233] DMS-REQ-0390-V-01: Re-Runs on Other Systems\_1 }\label{lvv-18233}
...
Requirement Description & \textbf{Specification:} A re-run based on provenance, if run on a
...
system loads). \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} ``To the extent computationally feasible'' refers
...
hardware differences, but they cannot be avoided altogether. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0122 & Provenance \\
...
results produced are the same to the extent computationally feasible.~
 ...
 \newpage \subsection{[LVV-18234] DMS-REQ-0389-V-01: Re-Runs on Similar Systems\_1 }\label{lvv-18234}
...
Requirement Description & \textbf{Specification:} A re-run based on provenance, if run on the same
...
time or on variable system loads). \\ \cdashline{1-2}
Requirement Discussion & \textbf{Discussion:} ``System software'' refers to the substrate of
...
same for a provenance-based re-run. \\ \cdashline{1-2}
Requirement Priority & 1b \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
OSS-REQ-0122 & Provenance \\
...
produces the same results.~
 ...
 \newpage \subsection{[LVV-18295] DMS-REQ-0394-V-01: Data Management Nightly Reporting\_1 }\label{lvv-18295}
...
Requirement Description & \textbf{Specification:} The LSST Data Management subsystem shall produce
...
a user defined period of time (e.g. the previous 24 hours). \\ \cdashline{1-2}
Requirement Priority & 1a \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
period of time (e.g. the previous 24 hours).
 ...
 \newpage \subsection{[LVV-18298] DMS-REQ-0392-V-01: Alert Delay and Failure Tolerances\_1 }\label{lvv-18298}
...
Requirement Description & \textbf{Specification:} The system shall reliably produce alerts for
...
and distribute alerts (integrated over all stages of data handling) \\ \cdashline{1-2}
...
Requirement Discussion & \textbf{Discussion:} As with DMS-REQ-0004, this specification applies to
visits which should have resulted in fewer than
\textbf{nAlertVisitPeak}. \\ \cdashline{1-2}
Requirement Priority & 2 \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
\end{longtable}
 ...
 \newpage \subsection{[LVV-18299] DMS-REQ-0393-V-01: Performance Requirements for Transient Alert
...
Requirement Description & \textbf{Specification:} The system shall be able to identify and
...
\textbf{nAlertVisitAvg}. \\ \cdashline{1-2}
...
Requirement Discussion & \textbf{Discussion:} The term `degrade gracefully' means that visits
...
alerts from that visit, potentially with greater latency. \\ \cdashline{1-2}
Requirement Priority & 2 \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
\end{longtable}
 ...
 \newpage \subsection{[LVV-18339] DMS-REQ-0359-V-18: Outlier limit on zero points }\label{lvv-18339}
...
\end{longtable}
 ...
 \newpage \subsection{[LVV-18465] DMS-REQ-0395-V-01: Scientific Visualization of Camera Image Data\_1 }\label{lvv-18465}
...
Requirement Description & \textbf{Specification:} All scientific visualization of camera image
data shall use the coordinate systems defined in \citeds{LSE-349}. \\ \cdashline{1-2}
Requirement Priority & 1a \\ \cdashline{1-2}
Upper Level Requirement &
\begin{tabular}{cl}
...
coordinate systems defined in \href{https://lse-349.lsst.io/}{LSE-349}.
 ...
 \newpage \subsection{[LVV-18881] DMS-REQ-0282-V-02: Dark Current Correction Frame Effectiveness }\label{lvv-18881}
